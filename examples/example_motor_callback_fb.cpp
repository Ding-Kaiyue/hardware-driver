...
int main() {
    ...
    try {
        ...
        // 使能电机
        std::cout << "\n步骤1: 使能电机" << std::endl;
        // robot.enable_motor("can0", 1, 4);  // 使能can0上的电机1，模式4
        // robot.enable_motor("can0", 9, 4);  // 使能can0上的电机1，模式4

        std::cout << "\n步骤2: 控制电机运动" << std::endl;

        // 正向旋转
        std::cout << "正向旋转 5 度/秒..." << std::endl;
        robot.control_motor_in_velocity_mode("can0", test_motor1, 5.0);  // 速度模式，5 degrees/s
