...
//             // 发送双电机同步位置控制命令
//             robot_hardware_->send_realtime_position_command("can0", {i * 0.1, i * 0.2}, {0.05, 0.05}, {0.01, 0.01});
...
//             // 禁用电机
//             robot_hardware_->disable_motor("can0", 1, 0x04);
//             robot_hardware_->disable_motor("can0", 9, 0x04);
...
//         temp_hardware->disable_motor("can0", 1, 0x04);
//         temp_hardware->disable_motor("can0", 9, 0x04);
//         std::this_thread::sleep_for(std::chrono::milliseconds(200));
